...
# win32v8.mak - Make file for Windows using Microsoft MSVC v8.0 development kit.
#
...
#	Run "nmake -f win32v8.mak spotless"   to clean source directory even more
#
##############################################################################
#
# Microsoft MSCV 6.0 install directory
TOOLSDIR      = c:\Program Files\Microsoft Visual Studio 8\VC
#
...
LD            =	link
INSTALL       =	copy
CDEBUG        =	-nologo -Gy -W3 -Zi -Od -D_DEBUG
COPTIMISE     =	-nologo -Gy -W3 -O2 -DNDEBUG=1
CDEFS         = -D_WIN32 -I. "-I$(TOOLSDIR)\include" "-I$(TOOLSDIR)\PlatformSDK\include" -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE
...
.rc.res:	
	$(RC) -v -i . -i "$(TOOLSDIR)\include" -fo $@ $*.rc 
