...
#
#	Run "nmake -f win32v6.mak"      for optimised build produces ./me32.exe
#	Run "nmake -f win32v6.mak mec"  for console support          ./mec32.exe
#	Run "nmake -f win32v6.mak med"  for debug build produces     ./med32.exe
#
#	Run "nmake -f win32v6.mak clean"      to clean source directory
#	Run "nmake -f win32v6.mak spotless"   to clean source directory even more
#
##############################################################################
#
