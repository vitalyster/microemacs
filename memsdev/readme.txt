========================================================================
       DEVELOPER STUDIO ADD-IN : meMsdev
========================================================================


The Add-in Wizard has created this meMsdev DLL for you.  This DLL not only
...
meMsdev.cpp
	This is the main DLL source file.  It contains the class CMeMsdevApp.
...
Commands.cpp, Commands.h
    ...
    a sample command (MeMsdevCommand) which displays a message
...
StdAfx.h, StdAfx.cpp
    ...
    named meMsdev.pch and a precompiled types file named StdAfx.obj.
