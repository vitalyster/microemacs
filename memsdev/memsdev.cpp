// meMsdev.cpp : Defines the initialization routines for the DLL.
//
...
class CMeMsdevApp : public CWinApp
{
public:
	CMeMsdevApp();
...
BEGIN_MESSAGE_MAP(CMeMsdevApp, CWinApp)
//{{AFX_MSG_MAP(CMeMsdevApp)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// The one and only CMeMsdevApp object

CMeMsdevApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CMeMsdevApp construction

CMeMsdevApp::CMeMsdevApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// CMeMsdevApp initialization

BOOL CMeMsdevApp::InitInstance()
{
    _Module.Init(ObjectMap, m_hInstance);
    return CWinApp::InitInstance();
}

int CMeMsdevApp::ExitInstance()
{
    _Module.Term();
...
STDAPI DllRegisterServer(void)
{
	...
	if (lRes == ERROR_SUCCESS)
	{
		...
		if (lRes == ERROR_SUCCESS)
		{
			...
			strDescription.LoadString(IDS_MEMSDEV_DESCRIPTION);
